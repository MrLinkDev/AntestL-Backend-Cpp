/**
 * \file
 * \brief Заголовочный файл, в котором объявляются класс SocketServer
...
/**
 * \brief Класс SocketServer, в котором имеется набор методов для
 * установки соединения и обмена данными с клиентом
 */
class SocketServer {
