...
#define LEVEL_WARN  1
/// Уровень логирования, при котором отображаются ошибки, предупреждения
/// и информационные сообщения
#define LEVEL_INFO  2
/// Уровень логирования, при котором отображаются ошибки, предупреждения,
/// информационные сообщения и отладочные сообщения
#define LEVEL_DEBUG 3
/// Уровень логирования, при котором отображаеются все сообщения, включая
...
/**
 * \brief Функция, которая снимает значение текущего времени и конвертирует
 * его в строку с заданным шаблоном.
 *
...
class Logger {
    ...
    /**
     * \brief Возвращает тег в зависимости от уровня логирования и от назначения тега.
     *
    ...
    /**
     * \brief Метод, который выводит сообщение в консоль.
     *
    ...
    /**
     * \brief Метод, который записывает сообщение в файл.
     *
...
public:
    ...
    /**
     * \brief Метод, осуществляющий логирование
     *
     * Данный метод сравнивает текущий уровень логирования с уровнем входящего сообщения.
